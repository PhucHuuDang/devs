...
export const ThemeToggleButton4 = ({
  ...
  if (isDark === null) return <Skeleton className="size-7" />;
  return (
    <button
      type="button"
      className={cn(
...
export const ThemeToggleButtonStyles = ({
  className = "size-7 cursor-pointer hover:scale-105 transition duration-300",
}: {
  className?: string;
}) => {
  return <ThemeToggleButton4 className={className} />;
};
