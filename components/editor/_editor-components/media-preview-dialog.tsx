...
export function MediaPreviewDialog() {
  ...
  const hoverStyle =
    "hover:bg-slate-100/10 cursor-pointer transition-all duration-300";
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative flex max-h-screen w-full items-center">
          <PreviewImage
            className={cn(
              "mx-auto block max-h-[calc(100vh-4rem)] rounded-3xl w-auto object-contain transition-transform"
            )}
          />
          <div
          ...
          >
            ...
            <button className={cn(buttonVariants(), hoverStyle)} type="button">
              <Download className="size-4" />
            </button>
            <button
              {...closeProps}
              className={cn(buttonVariants(), hoverStyle)}
              type="button"
            >
              <X className="size-4" />
            </button>
