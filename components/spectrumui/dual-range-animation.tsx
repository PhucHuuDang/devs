...
const DualRangeSliderAnimation = React.forwardRef<
        ...
        <>
          {initialValue.map((value, index) => (
            <React.Fragment key={index}>
              <SliderPrimitive.Thumb className="relative block h-4 w-4 rounded-full border-2 border-primary dark:bg-neutral-800 bg-neutral-50 ring-offset-background  focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer hover:scale-110 duration-300 transition-all">
...
export { DualRangeSliderAnimation };
