...
import { blockSelectionVariants } from "../editor/_editor-components/block-selection";
import {
  ColorDropdownMenuItems,
  DEFAULT_COLORS,
} from "../editor/_editor-components/font-color-toolbar-button";
import { ResizeHandle } from "../editor/_editor-components/resize-handle";
import {
  BorderAllIcon,
  BorderBottomIcon,
  BorderLeftIcon,
  ...
  BorderRightIcon,
  BorderTopIcon,
} from "../editor/_editor-components/table-icons";
import {
  Toolbar,
  ToolbarButton,
  ToolbarGroup,
  ToolbarMenuGroup,
} from "../editor/control/toolbar";
...
export function TableRowElement(props: PlateElementProps<TTableRowElement>) {
  const { element, attributes, ref, getOption, children } = props;
  const readOnly = useReadOnly();
  const selected = useSelected();
  const editor = useEditorRef();
  const isSelectionAreaVisible = usePluginOption(
